...
from api2.views import product_detail,product_list,category_detail,category_list,category_product
...
urlpatterns = [
    ...
    path('api/categories/<int:categoryid>/products/', category_product)
]
